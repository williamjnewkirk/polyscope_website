...
<p>Polyscope is a mobile application available on iOS that provides real-time Polymarket prediction market intelligence to retail traders. The app monitors publicly available on-chain trading activity on the Polygon blockchain and surfaces whale wallet activity, high-conviction trade signals, and AI-powered trade analysis through a subscription-based mobile experience. Polyscope allows users to track specific Polymarket wallet addresses of their choosing and receive push notifications when those wallets execute trades. The app also surfaces high-volume trades exceeding $100,000 USDC across the Polymarket platform, flagged as high-conviction signals. Pro subscribers have access to an AI-powered trade advisor that synthesizes recent whale activity and market data to provide informational trade insights. The app operates two subscription tiers: a free tier with limited wallet tracking and notifications, and a Pro tier with unlimited access to every feature in the app, including the AI trade advisor. Current pricing is shown in the app and at polyscopeapp.com. Subscriptions are managed through Apple In-App Purchase. A 7-day free trial is available for new subscribers on monthly and yearly plans. Polyscope is a data aggregation and intelligence tool. It does not facilitate the placement of trades, hold user funds, or provide licensed financial advice. All market data displayed is sourced from publicly available blockchain records and the Polymarket Gamma API.</p>
...
<h3>Free Trial</h3>
<p>We offer a 7-day free trial to new users on monthly and yearly subscription plans. The account will be charged according to the user's chosen subscription at the end of the free trial. Weekly plans are billed immediately and do not include a free trial.</p>
<h3>Cancellation</h3>
