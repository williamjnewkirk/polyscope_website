...
<p>This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Apple Media Services Terms and Conditions ("Usage Rules"). Newkirk Technologies LLC acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.</p>
<p>Polyscope when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Polyscope is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS").</p>
...
<p>3.1 The Licensed Application requires iOS 14.0 or higher. Licensor recommends using the latest version of the operating system.</p>
