...
<li>Use Polyscope. Polyscope is a mobile application available on iOS that provides real-time Polymarket prediction market intelligence to retail traders. The app monitors publicly available on-chain trading activity on the Polygon blockchain and surfaces whale wallet activity, high-conviction trade signals, and AI-powered trade analysis through a subscription-based mobile experience. Polyscope allows users to track specific Polymarket wallet addresses of their choosing and receive push notifications when those wallets execute trades. The app also surfaces high-volume trades exceeding $100,000 USDC across the Polymarket platform, flagged as high-conviction signals. Pro subscribers have access to an AI-powered trade advisor that synthesizes recent whale activity and market data to provide informational trade insights. The app operates two subscription tiers: a free tier with limited wallet tracking and notifications, and a Pro tier with unlimited access to every feature in the app, including the AI trade advisor. Current pricing is shown in the app and at polyscopeapp.com. Subscriptions are managed through Apple In-App Purchase. A free trial is available for new subscribers on monthly and yearly plans. Polyscope is a data aggregation and intelligence tool. It does not facilitate the placement of trades, hold user funds, or provide licensed financial advice. All market data displayed is sourced from publicly available blockchain records and the Polymarket Gamma API. Category: Finance / Investment Tools. Target Audience: Adult retail traders actively using the Polymarket prediction market platform. The app is intended for users 17 and older and is not directed at minors. Platform: iOS mobile application. Developer/Company: Newkirk Technologies LLC (Colorado).</li>
...
<p>Polyscope accepts subscription payments through Apple In-App Purchase, managed through RevenueCat. Users complete purchases directly within the app when upgrading to Pro.</p>
